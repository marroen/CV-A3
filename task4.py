...
from models import LeNet5C_20
from cifar100_data import train_loader, val_loader, test_loader, test_dataset, test_dataset_100
...
LeNet5C_20_weights = LeNet5C_20().to(device)
torch.save(LeNet5C_20_weights.state_dict(), "LeNet5C_20_weights.pth")

# Optional: Class-wise accuracy (using test set)
model = models_to_train["LeNet5C_20"]  # Example using model C
all_labels = []
all_preds = []
...
print(classification_report(all_labels, all_preds, target_names=(test_dataset_100.classes[:20])))
